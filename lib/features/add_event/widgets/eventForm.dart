...
class _EventFormState extends State<EventForm> {
  ...
  void initState() {
    ...
    hostNameController = TextEditingController(text: widget.event?.hostName ?? '');
    attendeesController = TextEditingController(text: widget.event?.capacity.toString() ?? '');
    startDateController = TextEditingController(text: widget.event?.date.split(' - ')[0] ?? '');
   endDateController = TextEditingController(
  text: widget.event != null && widget.event!.date.contains(' - ')
  ...
  text: widget.event != null && widget.event!.time.contains(' - ')
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextFormField(
              ...
              validator: (val) => val!.isEmpty ? 'Please enter your event title' : null,
            ),
            ...
            Padding(
              ...
              child: DropdownButtonFormField<String>(
                ...
                decoration: CustomInputDecoration.getDecoration(hintText: 'Select event type'),
                validator: (value) => value == null ? 'Please select your event type' : null,
              ),
            ),
            ...
            CustomTextFormField(
              ...
              validator: (val) => val!.isEmpty ? 'Please enter your event description' : null,
            ),
            ...
            ElevatedButton(
              ...
              onPressed: () {
                if (_formKey.currentState!.validate()) {
                  ...
                  String date = '${startDateController.text} - ${endDateController.text}';
              ...
              child: Text(widget.isEdit ? 'Update Event' : 'Create Event', style: const TextStyle(color: Colors.white)),
            )
          ],
        ),
      ),
