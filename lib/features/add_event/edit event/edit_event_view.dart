...
class _EditEventViewState extends State<EditEventView> {
  ...
  void initState() {
    ...
    capacityController = TextEditingController(text: widget.event.capacity.toString());
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              children: [
                      ...
                      image: DecorationImage(
                        image: newImageFile != null
                            ...
                            : (widget.event.image != null && widget.event.image!.isNotEmpty
                                ...
                                : AssetImage('assets/images/template${widget.event.templateIndex}.jpg') as ImageProvider),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                ...
                _buildTextField(capacityController, "Capacity", keyboard: TextInputType.number),
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    context.read<CreateEventCubit>().updateEvent(
                      ...
                      capacity: int.tryParse(capacityController.text) ?? widget.event.capacity,
                  ...
                  child: const Text("Update Event", style: TextStyle(color: Colors.white, fontSize: 16)),
                ),
              ],
            ),
          );
